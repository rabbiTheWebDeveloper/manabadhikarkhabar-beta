...
export const metadata: Metadata = {
  ...
  description: 'মানবাধিকার খবর (Manabadhikar Khabar) একটি আধুনিক ও নির্ভীক বাংলা নিউজ পোর্টাল। স্থানীয় ও জাতীয় সর্বাধিক ও সর্বশেষ খবরাখবর সবার আগে অত্যন্ত সত্যতার সাথে তুলে ধরাই আমাদের প্রধান অঙ্গিকার।',
  ...
  openGraph: {
    ...
    description: 'মানবাধিকার খবর দেশ ও বিদেশের স্থানীয় খবর, রাজনীতি, সমাজ, খেলাধুলা ও বস্তুনিষ্ঠ সংবাদের নির্ভরযোগ্য মাধ্যম।',
